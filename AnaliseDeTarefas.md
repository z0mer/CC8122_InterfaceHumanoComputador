...
* **GOAL 1:** Sincronizar os dados da sessão
    * **METHOD 1.A:** Sincronização automática via cabo USB
        ...
        * **OP 1.A.2:** Deslocar o mouse para o botão "Importar Sessão"
        * **OP 1.A.3:** Clicar com o botão esquerdo do mouse
    ...
    * **METHOD 1.B:** Sincronização automática via Bluetooth
        ...
        * **OP 1.B.2:** Deslocar o mouse para o botão "Sincronizar via Bluetooth"
        * **OP 1.B.3:** Clicar com o botão esquerdo do mouse
...
* **GOAL 2:** Localizar o evento crítico (a curva com erro)
    * **METHOD 2.A:** Selecionar a volta na lista de histórico
        ...
        * **OP 2.A.1:** Deslocar o cursor do mouse para a lista de histórico de voltas
        * **OP 2.A.2:** Clicar sobre a volta correspondente na lista
        * **OP 2.A.3:** Aguardar resultado da análise do erro
    * **METHOD 2.B:** Fazer busca pelo evento ou volta
        ...
        * **OP 2.B.1:** Deslocar o cursor do mouse para o campo de busca
        ...
        * **OP 2.B.5:** Aguardar resultado da análise do erro
